...
### Footer with Linear reference and agent co-author

```
feat(web): Add repository activity sparkline cards

Render compact sparkline cards on the workspace overview page to make
weekly repository activity easier to scan.
